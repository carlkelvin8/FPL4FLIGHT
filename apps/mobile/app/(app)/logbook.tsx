...
function generateLogbookPDF(entries: LogEntry[]): string {
  ...
  return `<html><head><style>body{font-family:sans-serif;margin:0;}table{font-size:9px;}td,th{padding:3px 4px;text-align:center;}@page{size:landscape;margin:8mm;}</style></head><body>${pages}<p style="text-align:center;font-size:9px;color:#94a3b8;">Generated by FPL4FLIGHT • ${new Date().toISOString().slice(0, 10)}</p></body></html>`;
}
